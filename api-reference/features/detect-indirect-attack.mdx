...
- [Endpoints](#endpoints)
  ...
  - [Check CID](#check-cid)
  - [Log Sensitive Prompt](#log-sensitive-prompt)
  - [LLM Interface Loaded](#llm-interface-loaded)
...
- **URL**: `/v1/send-api-key`
- **Method**: `POST`
- **Description**: Initiates the process to generate and send an API key to the user.
- **Request Body**:
...
- **URL**: `/v1/api-key`
- **Method**: `GET`
- **Description**: Retrieves the API key associated with a given ID.
- **Query Parameters**:
  - `id` (required): The unique identifier for the API key retrieval.
...
- **URL**: `/v1/check-cid`
- **Method**: `POST`
- **Description**: Checks the validity of a given CID (Client ID).
- **Request Body**:
...
- **URL**: `/v1/log-prompt`
- **Method**: `POST`
- **Description**: Logs sensitive prompts detected in the system, including details about the user and the nature of the sensitive data.
- **Request Body**:
...
- **Response**:
  ...
  {
    "status": "success",
    "message": "Sensitive prompt logged successfully."
  }
  ```

### LLM Interface Loaded

- **URL**: `/v1/llm-loaded`
- **Method**: `POST`
- **Description**: Notifies the backend when a Large Language Model (LLM) interface has been loaded.
- **Request Body**:

  ```json
  {
    "model_name": "LLM_Model_XYZ",
    "user": "john_doe",
    "department": "Research",
    "cid": "client_identifier"
  }
...
- **Response**:
  ...
  {
    "status": "success",
    "message": "LLM interface loaded notification received."
  }
  ```
