...
**Note**: Replace the base URL (e.g., `http://195.242.13.11:8001`) with your actual server address.
...
BASE_URL = "http://195.242.13.11:8001/v1"
...
- **Endpoint URL**: Adjusted to point to `http://195.242.13.11:8001/v1/detect-indirect-attack`.
